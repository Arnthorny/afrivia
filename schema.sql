...
-- Database: PostgreSQL
-- Generated at: 2024-09-03T20:02:05.728Z
...
COMMENT ON TABLE "options" IS 'This table holds all options in the trivia db';
...
ALTER TABLE "trivias" ADD FOREIGN KEY ("submision_id") REFERENCES "submissions" ("id");

ALTER TABLE "options" ADD FOREIGN KEY ("trivia_id") REFERENCES "trivias" ("id");
